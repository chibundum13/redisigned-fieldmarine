<?php
session_start();
$page = "Vision and Mission Page";
$active = "about";
$pagetitle = "Vision &amp; Mission | Engineering";
...
<body class="royal_preloader">
    ...
    <div id="wrapper" class="wrapper clearfix">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                        <div class="heading mb-50 text--center">
                            <h2 class="heading--title mb-3">Our Vision</h2>
                            <p class="heading--desc text-mint mb-0">To become the preferred provider of tailor-made, strategic solutions for our clients and contractors in the Nigerian energy sector and beyond.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row flipInX" data-wow-delay="100ms">
                    <div class="col-sm-12 col-md-10 offset-md-1">
                        <div class="heading heading-2 mb-50 text--center">
                            ...
                            <p class="heading--desc mb-0">To enable economic growth through infrastructure and energy development, and to provide solutions that support our clients, employees, partners and the community at large.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="page-img" class="bg-overlay bg-overlay-dark">
            <div class="page-img">
                <img src="assets/images/fm-strategy.jpg" alt="Fieldmarine Strategy" />
            </div>
        </section>
